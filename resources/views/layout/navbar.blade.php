<nav class="navbar top-navbar">
    <div class="container-fluid">
        <div class="navbar-left">
            ...
            <ul class="nav navbar-nav"><h5 class="pr-1"> Doito</h5></ul>
        ...
        <div class="navbar-right">
            <div id="navbar-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li title="تسجيل الخروج">
                        <form class="icon-menu" action="{{route('logout')}}" method="POST">
                        @csrf
                        <button style="background: none; border:none; color:inherit; padding: 0px; margin: 0px; " type="submit" class="icon-menu"><i class="icon-power"></i></button>
                    </form>
                </li>
                </ul>
            </div>
